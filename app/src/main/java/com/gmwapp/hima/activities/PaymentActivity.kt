...
//                    binding.tvCoins.text = it.data?.coins.toString()
    ...
    private fun fetchOrderOfCashfree(coinId: String) {
        ...
        Log.d("CashfreeOrder", "User ID: $user_id, Coin ID: $coinId, Coupon ID: $couponIdToPass")
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: okhttp3.Call, response: Response) {
                ...
                if (!response.isSuccessful) {
                    ...
                    runOnUiThread {
                        Toast.makeText(this@PaymentActivity, "Server error (${response.code}): ${response.message}", Toast.LENGTH_SHORT).show()
                    }
                    return
                }
                ...
                try {
                    ...
                    if (success) {
                        ...
                        Log.e("CashfreeOrder", "===============================================")
                        runOnUiThread {
                            Toast.makeText(this@PaymentActivity, errorMsg.ifEmpty { errors }, Toast.LENGTH_SHORT).show()
                        }
                    }
                } catch (e: Exception) {
            ...
            override fun onResponse(call: okhttp3.Call, response: Response) {
                ...
                try {
                    ...
                    if (paymentStatus.equals("PAID", ignoreCase = true)) {
                        ...
                        Log.e("CashfreeStatus", "==========================================")
                        runOnUiThread {
                            Toast.makeText(this@PaymentActivity, "Payment Failed (Status: $paymentStatus)", Toast.LENGTH_LONG).show()
                        }
                    }
                } catch (e: Exception) {
